...
def test_rx_image_for_Covid19(model, imagePath, filename):
    ...
    cv2.imwrite(r"C:\Users\USER\X-Ray_Covide_development\input\20_covid19XrayWebApp\static\xray_analisys"+img_pred_name, img_out)
...
prediction=' '
confidence=0
filename=r"C:\Users\USER\X-Ray_Covide_development\input\20_covid19XrayWebApp\static\Image_No_Pred_MJRoBot.png"
image_name = filename
